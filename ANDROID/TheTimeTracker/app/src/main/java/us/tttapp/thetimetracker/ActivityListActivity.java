 ...
 * {@link ActivityListFragment} and the item details
 * (if present) is a {@link ActivityDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link ActivityListFragment.Callbacks} interface
...
public class ActivityListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.activity_detail_container) != null) {
            ...
            ((ActivityListFragment) getFragmentManager()
    ...
    /**
     * Callback method from {@link ActivityListFragment.Callbacks}
